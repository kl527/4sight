...
// ============================================================================
// WINDOW EXTRACTION RESULT (includes intermediate signals for visualization)
// ============================================================================

/**
 * Complete extraction result including intermediate signal data for graphing.
 */
export interface WindowExtractionResult {
  windowId: string;
  timestamp: number;
  features: BiosignalFeatures | null;
  rawPPG: number[];
  preprocessedPPG: number[];
  accelX: number[];
  accelY: number[];
  accelZ: number[];
  rrIntervals: number[];
